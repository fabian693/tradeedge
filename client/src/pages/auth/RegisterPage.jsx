...
export default function RegisterPage() {
  ...
  const { register: registerUser, loginGoogle, isAuthenticated } = useAuth()
  ...
  useEffect(() => {
    if (isAuthenticated) navigate('/psychology/baseline', { replace: true })
  ...
  async function onSubmit(values) {
    try {
      ...
      navigate('/psychology/baseline', { replace: true })
    } catch (err) {
    ...
    <div className="min-h-screen bg-background flex items-center justify-center p-4">
      ...
      <div className="w-full max-w-sm relative">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-sm text-secondary">Start journaling your trades professionally</p>
        </div>
